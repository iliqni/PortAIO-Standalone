    ...
    public static class GameObjects
    {
            ...
            Loading.OnLoadingComplete += (args) =>
                {
                    ...
                    MinionsList.AddRange(
                        ObjectManager.Get<Obj_AI_Minion>()
                            .Where(
                                o =>
                                o.Team != GameObjectTeam.Neutral && !o.BaseSkinName.ToLower().Contains("ward")
                                && !o.BaseSkinName.ToLower().Contains("trinket")
                                && !o.BaseSkinName.Equals("gangplankbarrel")));
        ...
        private static void OnCreate(GameObject sender, EventArgs args)
        {
            ...
            if (minion != null)
            {
                ...
                {
                    if (minion.BaseSkinName.ToLower().Contains("ward")
                        || minion.BaseSkinName.ToLower().Contains("trinket"))
                    {
                    ...
                    else if (!minion.BaseSkinName.Equals("gangplankbarrel"))
                    {
